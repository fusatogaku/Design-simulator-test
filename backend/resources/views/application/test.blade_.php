...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
            ...
            <div class="mainContent-wrap">
                ...
                <div id="canvas-wrap">
                    ...
                    <div id="test" class="test" style="display: none;">
                        <div id="textPreviewCanvas"><canvas id="previewArea" width="352" height="60"></canvas></div>
                    ...
                    <div class="options">
                        <img src="/storage/items/delete.png" alt="" id="delete-btn" class="option">
                        <img src="/storage/items/bx-reset.png" alt="" id="roll-btn" class="option">
                        <img src="/storage/items/scaleup.png" alt="" id="scaleUp-btn" class="option">
                        <img src="/storage/items/scaledown.png" alt="" id="scaleDown-btn" class="option">
                        <img src="/storage/items/reset.png" alt="" id="reset-btn" class="option">
                    </div>
                    <!--  -->
                    <div id="loading-box">
                ...
                <div class="palette bottom">
                    ...
                    <a id="insertTextBtn" for="cBox-text">
                        <ul>
        ...
        <!-- <div id="preload-imgs" style="dispaly: none;"> -->
        <div id="preload-imgs">
            @foreach($stickies as $sticky)
            <?php $fileName = str_replace('public/items/', '', $sticky->itemName); ?>
        ...
        <div class="checkBoxs">
            <input type="checkbox" id="cBox-bgColor">
            <input type="checkbox" id="cBox-text">
            <input type="checkbox" id="cBox-sticky">
            <input type="checkbox" id="cBox-layer">
            <input type="checkbox" id="cBox-file">
        </div>
    </body>
</html>
